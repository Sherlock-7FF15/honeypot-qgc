...
def handle(req, fds):
    ...
    if action == "launch":
        ...
        env = {
            ...
            "SESSION_DIR": req.get("session_dir", ""),
            "WORKSPACE": req.get("workspace", "/"),
            "BASELINE_FILE": req.get("baseline_file", ""),
            "BASELINE_META": req.get("baseline_meta", ""),
            "LOGIN_USER": req.get("login_user", ""),
            "SHADOW_WORKSPACE": req.get("shadow_workspace", "/"),
            "SHADOW_LOGIN_USER": req.get("login_user", ""),
            "CMD_LOG": req.get("cmd_log", ""),
